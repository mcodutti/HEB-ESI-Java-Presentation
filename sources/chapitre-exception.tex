...
(ex: \java{ArrayOutOfBoundsException})
...
\begin{frame}[fragile]{Exceptions contrôlées}
Si une méthode \emph{peut} lancer une exception \emph{controlée}
\begin{itemize}
...
Quand on appelle une méthode qui \emph{peut} lancer une exception \emph{controlée}
  \begin{itemize}
...
\emph{Remarque} : Si on n'avait pas fait le test de dépassement de capacité
  \begin{itemize}
  \item \code|ArrayList| aurait lancé une \java|IndexOutOfBoundsException|
