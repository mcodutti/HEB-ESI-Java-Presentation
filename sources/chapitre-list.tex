...
\begin{frame}[fragile]{Déclaration / Création}
Écriture vieillie (\emph{non recommandée}) : \\Ne pas mettre les \java|<>|
\begin{Java}
  ArrayList liste = new ArrayList ();
\end{Java}
\medskip
\includegraphics[scale=.5]{../img/java7.jpeg}En Java7, on peut ne plus spécifier le type des éléments à droite (déduit par le compilateur)
\begin{Java}
...
\item Existence de \textit{wrapper} (\textit{enveloppe})
  ...
  \item Conversion automatique de l'un à l'autre
  \end{itemize}
\end{itemize}
\begin{center}
\begin{tabular}{r|l}
